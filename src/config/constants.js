...
export const feedbacks = [
  {
    ...
    text: "Очень понравился ассортимент чаёв! Особенно впечатлила коллекция зелёных чаёв. Обслуживание приятное, чувствуется забота о клиентах.",
    avatar: "/assets/Images/avatar.png",
  },
  {
    fullName: "Иван Петров",
    text: "Заказал несколько видов чая на пробу, и все оказались отличными. Цены адекватные, качество на высоте. Буду заказывать снова.",
    avatar: "/assets/Images/avatar.png",
  },
  {
    fullName: "Елена Кузнецова",
    text: "Чай просто восхитительный! Люблю пробовать новые вкусы, и здесь есть из чего выбрать. Быстрая доставка тоже порадовала.",
    avatar: "/assets/Images/avatar.png",
  },
  {
    fullName: "Ольга Сидорова",
    text: "Чайная только открылась, но уже видно, что ребята делают всё с душой. Чай вкусный, а коробочки красивые и аккуратные.",
    avatar: "/assets/Images/avatar.png",
  },
  {
    fullName: "Сергей Иванов",
    text: "Уже несколько раз заказывал чай у них. Каждый раз всё на высшем уровне: и вкус, и качество. Особенно понравился улун.",
    avatar: "/assets/Images/avatar.png",
  },
  {
    fullName: "Мария Васильева",
    text: "Никогда не думала, что можно так увлечься чаем! Отличный выбор, и каждый сорт — это что-то особенное. Рекомендую всем любителям чая.",
    avatar: "/assets/Images/avatar.png",
  },
];
