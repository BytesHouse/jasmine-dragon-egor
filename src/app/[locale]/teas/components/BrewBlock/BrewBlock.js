...
const BrewBlock = ({ product }) => {
  ...
  return (
    <section className="flex flex-col gap-[25px]">
      ...
      <div className="grid grid-cols-4 brew gap-[25px]">
        <div className="flex flex-col items-start gap-[15px]">
          <Image width={100} height={100} src={image1} alt="time" />
        ...
        <div className="flex flex-col items-start gap-[15px]">
          <Image width={100} height={100} src={image2} alt="balance" />
          <h3>Размер порции</h3>
          <p>
        ...
        <div className="flex flex-col items-start gap-[15px]">
          <Image width={100} height={100} src={image3} alt="temp" />
          <h3>Температура</h3>
          <p>
        ...
        <div className="flex flex-col items-start gap-[15px]">
          <Image width={100} height={100} src={image4} alt="reverse" />
          <h3>Как много раз</h3>
          <p>
